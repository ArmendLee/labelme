...
class MainWindow(QtWidgets.QMainWindow, WindowMixin):
    ...
    def __init__(self, config=None, filename=None, output=None):
        ...
        createCarMode = action(
            'Create Car',
            lambda: self.toggleDrawMode(False, createMode='car'),
            shortcuts['create_car'],
            'objects',
            'Start drawing car. Ctrl+LeftClick ends creation.',
            enabled=False,
        )
    ...
    def setClean(self):
        ...
        self.actions.createCarMode.setEnabled(True)
    ...
    def toggleDrawMode(self, edit=True, createMode='polygon'):
        ...
        if edit:
            ...
            if createMode == 'polygon':
                ...
                self.actions.createPointMode.setEnabled(True)
                self.actions.createLineStripMode.setEnabled(True)
                self.actions.createCarMode.setEnabled(False)
