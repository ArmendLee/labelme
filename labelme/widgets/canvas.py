...
class Canvas(QtWidgets.QWidget):
    ...
    def mouseMoveEvent(self, ev):#重点修改
                ...
                if self.current:
                    ...
                    #added by lihaodong
                        ...
                        if len(self.current.points)<4:
                            self.current.addPoint(self.line[1])
                            self.line[0] = self.current[0]
                        elif len(self.current.points)<=6:
                            self.current.addPoint(self.line[-1])
                        if len(self.current.points)==6:
                            self.finalise()
                    ##
